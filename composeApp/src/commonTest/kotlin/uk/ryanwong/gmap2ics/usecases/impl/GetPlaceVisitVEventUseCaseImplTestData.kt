...
internal object GetPlaceVisitVEventUseCaseImplTestData {
    ...
    private val childVisitSomeChildPlaceId = ChildVisit(
    ...
    val placeVisitWithOneChildVisit = PlaceVisit(
        durationEndTimestamp = RawTimestamp(
        ...
        childVisits = listOf(childVisitSomeChildPlaceId),
        eventTimeZone = TimeZone(zoneId = "Europe/London", region = Polygon()),
    )

    val vEventSomeChildPlaceId = VEvent(
    ...
    private val childVisitSomeOtherChildPlaceId = ChildVisit(
        durationEndTimestamp = RawTimestamp(
            timestamp = "2022-01-03T14:25:00Z",
            timezoneId = "Europe/London",
        ),
    ...
    val placeVisitWithTwoChildVisit = PlaceVisit(
        durationEndTimestamp = RawTimestamp(
            timestamp = "2022-01-03T14:26:25Z",
            timezoneId = "Europe/London",
        ),
        ...
        childVisits = listOf(
            childVisitSomeOtherChildPlaceId,
            childVisitSomeChildPlaceId,
        ),
        eventTimeZone = TimeZone(zoneId = "Europe/London", region = Polygon()),
    )
}
